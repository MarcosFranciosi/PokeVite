...
.cardListPokemon {
    ...
    background: radial-gradient(circle, rgba(61, 52, 230, 0.5) 0%, rgba(70,252,244,0.3) 100%);
    cursor: pointer;
}
.cardListPokemon:hover {
    background: rgb(72,63,251);
    background: radial-gradient(circle, rgba(72,63,251,0.7) 0%, rgba(70,252,244,0.2) 100%);
    cursor: pointer;
}
